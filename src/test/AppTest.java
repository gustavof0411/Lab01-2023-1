...
//    @Test
//    public void testParMaisProximo() {assertEquals(1.414, App.parMaisProximo(new Integer[][]{new Integer[]{2, 4}, new Integer[]{5, 9}, new Integer[]{1, 3}, new Integer[]{8, 2}, new Integer[]{6, 7}}));
